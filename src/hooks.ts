 ...
 */
function ensureCore(): { configManager: ConfigManager; readerController: ReaderController } {
  ...
  try {
    ...
    if (typeof maybeGetter === "function") {
      ...
      if (core?.configManager && core?.readerController) {
        coreSnapshot = { configManager: core.configManager, readerController: core.readerController };
  ...
  if (configManagerSingleton && readerControllerSingleton) {
    coreSnapshot = { configManager: configManagerSingleton, readerController: readerControllerSingleton };
    return coreSnapshot;
  }
